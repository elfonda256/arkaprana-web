  ...
  return (
    <section id="solution-discovery" className="relative py-28 md:py-36 bg-white text-neutral-900 overflow-hidden border-b border-neutral-200">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {SOLUTION_DISCOVERY_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className={`px-4 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold tracking-wide transition-all cursor-pointer ${
                  isSelected
                    ? "bg-neutral-900 text-white shadow-md ring-2 ring-neutral-900"
        ...
        <div className="max-w-4xl mx-auto rounded-3xl bg-[#030712] text-white p-8 sm:p-12 shadow-2xl border border-white/[0.1] relative overflow-hidden">
          {/* Subtle Ambient Glow */}
          ...
          <div className="mb-8 pb-6 border-b border-white/[0.08]">
            ...
            <div className="text-lg sm:text-xl font-serif italic text-cyan-200">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="pt-4 flex flex-wrap items-center gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full text-xs font-semibold tracking-wide text-black bg-white hover:bg-neutral-200 transition-all shadow-md active:scale-[0.98]"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-3.5 rounded-full text-xs font-medium text-neutral-300 hover:text-white bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.1] transition-all"
                >
