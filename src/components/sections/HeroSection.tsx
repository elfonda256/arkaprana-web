      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-7 text-center lg:text-left">
            ...
            {/* Small Technical Eyebrow (Item 4) */}
            <div
              className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-white/[0.03] border border-white/[0.08] text-neutral-300 text-[11px] font-mono tracking-widest uppercase"
            ...
            {/* Quiet Credibility Architecture Indicators with Technical Labels */}
            <div
              className="pt-6 border-t border-white/[0.06] grid grid-cols-3 gap-6 max-w-lg mx-auto lg:mx-0 text-left"
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-lg lg:max-w-none">
              ...
              {/* Subtle backglow (reduced to 3-5% discoverable glow) */}
              <div className="absolute -inset-1 bg-gradient-to-b from-cyan-500/5 via-blue-500/3 to-transparent rounded-2xl blur-xl pointer-events-none" />

              {/* Hardware Console Container */}
              <div
                className="relative rounded-2xl overflow-hidden card-radial-glow border border-white/[0.08] shadow-xl p-5"
