        ...
        {SOLUTIONS.map((sol, idx) => {
          ...
          return (
            <div
              key={sol.id}
              id={sol.slug}
              className={`p-8 sm:p-10 rounded-3xl bg-[var(--bg-card)] border border-[var(--border-subtle)] hover:border-[var(--border-strong)] transition-all duration-300 shadow-sm hover:shadow-md grid grid-cols-1 lg:grid-cols-12 gap-8 items-center ${
                isReversed ? "lg:flex-row-reverse" : ""
              }`}
            >
              <div className="lg:col-span-7 space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border-subtle)] flex items-center justify-center text-[var(--accent-blue)]">
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="text-xs font-mono uppercase text-[var(--accent-blue)] tracking-wider">
                      {sol.badge} • {sol.category}
                    </span>
                    <h2 className="text-2xl font-semibold text-[var(--text-primary)] tracking-tight font-display">
                      {sol.name}
                    </h2>
                  </div>
                </div>
                ...
                {/* Capabilities Grid */}
                <div className="pt-2">
                  <h4 className="text-xs font-mono uppercase text-[var(--text-muted)] font-semibold mb-2">
                ...
                <div className="pt-4 flex items-center space-x-4">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-xs font-semibold uppercase tracking-wider text-white bg-[var(--accent-blue)] hover:opacity-90 transition-all shadow"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center text-xs font-medium text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors"
                  >
              ...
              <div className="lg:col-span-5 p-6 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--border-subtle)] space-y-4 font-mono text-xs">
                <div className="flex items-center justify-between pb-3 border-b border-[var(--border-subtle)] text-[var(--accent-blue)] font-semibold">
                  <span className="flex items-center gap-1.5">
                    <Layers className="w-4 h-4" />
                    TECHNICAL SPECS
                  </span>
                  <span className="text-[10px] text-[var(--text-muted)]">ENTERPRISE GRADE</span>
                </div>
                ...
                <div>
                  ...
                  <div className="text-[var(--text-secondary)] font-sans text-xs">
                ...
                <div className="pt-2">
                  ...
                  <ul className="space-y-1.5 text-[var(--text-secondary)] font-sans text-xs">
